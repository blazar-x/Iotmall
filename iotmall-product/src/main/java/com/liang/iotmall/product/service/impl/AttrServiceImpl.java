...
import com.liang.iotmall.product.dao.AttrDao;
...
public class AttrServiceImpl extends ServiceImpl<AttrDao, AttrEntity> implements AttrService {
     ...
     *
     * @param attrgroupId:
     * @return: java.util.List<com.liang.iotmall.product.entity.AttrEntity>
     */
    @Override
     ...
     * @param params:
     * @param attrgroupId:
     * @return: com.liang.common.utils.PageUtils
     */
    @Override
    public PageUtils getNoRelationAttr(Map<String, Object> params, Long attrgroupId) {
        ...
        //2.2这些分组关联的属性
        List<AttrAttrgroupRelationEntity> attrRelation = relationDao.selectList(new QueryWrapper<AttrAttrgroupRelationEntity>().in("attr_group_id", groupIds));
